...
const BrazilMap = () => {
  ...
  const pinLocations = [
    ...
    { x: '52%', y: '54%' }, { x: '56%', y: '56%' }, { x: '60%', y: '58%' },
    { x: '54%', y: '58%' }, { x: '58%', y: '60%' }, { x: '62%', y: '62%' },
    { x: '56%', y: '62%' }, { x: '60%', y: '54%' }, { x: '64%', y: '56%' },
    { x: '52%', y: '56%' }, { x: '58%', y: '54%' }, { x: '62%', y: '56%' },
    { x: '54%', y: '52%' }, { x: '58%', y: '56%' }, { x: '62%', y: '58%' },
    ...
    { x: '48%', y: '70%' }, { x: '52%', y: '72%' }, { x: '56%', y: '74%' },
    { x: '50%', y: '74%' }, { x: '54%', y: '76%' }, { x: '58%', y: '78%' },
    { x: '52%', y: '80%' }, { x: '56%', y: '82%' }, { x: '60%', y: '76%' },
    { x: '48%', y: '76%' }, { x: '52%', y: '82%' }, { x: '56%', y: '86%' },
    { x: '50%', y: '82%' }, { x: '54%', y: '84%' }, { x: '58%', y: '84%' },
    { x: '50%', y: '76%' }, { x: '54%', y: '78%' }, { x: '58%', y: '80%' },
    { x: '52%', y: '74%' }, { x: '56%', y: '76%' }, { x: '60%', y: '78%' },
  ];
